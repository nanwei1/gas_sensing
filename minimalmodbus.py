...
class Instrument():
    ...
    def read_long(self, registeraddress, functioncode=4, signed=False):
    ...
    def read_float(self, registeraddress, functioncode=4, numberOfRegisters=2):
    ...
    def read_string(self, registeraddress, numberOfRegisters=16, functioncode=4):
    ...
    def read_registers(self, registeraddress, numberOfRegisters, functioncode=4):
    ...
    def _performCommand(self, functioncode, payloadToSlave):
        ...
        """
        DEFAULT_NUMBER_OF_BYTES_TO_READ = 8
